...
const About = () => {
  ...
  useEffect(() => emailjs.init("5Q-JYLypQp2WfpdhD"), []);
  useEffect(() => {
    if (!isHovered) {
      ...
      return () => clearInterval(id); // Cleanup on unmount or hover change
    }
  }, [isHovered]); // Runs only when `isHovered` changes
            ...
            <div className="about-content">
              ...
              <div className="about-text">
                ...
                <p>
                  ...
                  Pradesh, We “Marv" are a Sole Proprietorship based firm,
                  engaged as the foremost Manufacturer, Wholesaler And Service
                  Provider of Modular Sofa, Wooden Temple, Interior Designing
                  Service and many more.We have a better pricing policy that
                  makes our products available at very competitive prices. We
                  offer easy modes of payment to avail our products according to
                  their convenience.
                </p>
              </div>
            </div>
            ...
            <div className="testimonials-row">
              <div className="testimonial">
                ...
                <p>
                  ...
                  expectations! The team really brought our vision to life.
                  Highly recommend!"
                </p>
                <h4>John Doe</h4>
              ...
              <div className="testimonial">
                ...
                />
                <p>
                  "Marv helped us redesign our office space. The atmosphere is
                  now much more comfortable and inspiring!"
                </p>
                <h4>Jane Smith</h4>
              ...
              <div className="testimonial">
                ...
                />
                <p>
                  "We love our new living room design! The attention to detail
                  and quality of work was exceptional. Thank you, Marv!"
                </p>
                <h4>Michael Brown</h4>
                <p>Client</p>
              </div>
              <div className="testimonial">
                ...
                />
                <p>
                  "The team at Marv is a pleasure to work with. Their designs
                  are modern, functional, and aesthetically pleasing."
                </p>
                <h4>Alice Green</h4>
                <p>Homeowner</p>
              </div>
            ...
            <div className="services-section">
              ...
              <div className="services-list">
                ...
                <div className="service-item">
                  ...
                  <p>
                    Custom furniture pieces designed to suit your style and
                    space requirements.
                  </p>
                </div>
                <div className="service-item">
